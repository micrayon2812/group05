                ...
                <div class="col-lg-6">
                    <div class="card2 card border-0 px-4 py-5">
                        ...
                        <div class="row px-3"> <label class="mb-1">
                            ...
                            </label> <input type="password" name="retypepassword" placeholder="Enter password again" required/> </div>
                        <div class="row px-3 mb-4">
                        ...
                        <div class="row mb-3 px-3" style={{color:`white`}}> <a href="/Login" class="btn btn-blue text-center" >Sign up</a></div>
                    </div>
                </div>
            </div>
        </div>
